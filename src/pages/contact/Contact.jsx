  ...
  return (
    <div>
      ...
      <section className="relative h-[92vh] bg-black px-6 py-20 text-textColor-primary md:px-10 lg:h-[90vh] xl:px-20 2xl:px-28">
        <div className="animate__animated animate__fadeInUp flex flex-col gap-3 place-self-end border-t border-gray-600 py-10 sm:grid sm:grid-cols-[1fr_2fr] lg:w-1/2 2xl:w-[40%]">
        ...
        <h1 className="animate__animated animate__fadeInUp mt-10 self-end text-[11vw] font-medium leading-none lg:absolute lg:bottom-10 lg:w-3/4 lg:text-[9vw]">
      ...
      >
        <article className="mt-10 flex flex-col gap-20 lg:mt-0 xl:gap-56">
          <div className="border- flex flex-col gap-10 border-gray-600 py-5 text-lg font-medium sm:grid sm:grid-cols-[1fr_2fr] sm:gap-20 sm:py-10 sm:text-xl lg:gap-40">
            <h1
              data-aos="fade-up"
              className="text-4xl font-semibold uppercase md:text-5xl lg:text-7xl"
            >
              Direct
            </h1>
            ...
            <div className="flex flex-col gap-5 text-textColor-secondary lg:gap-10">
              ...
              <span
                data-aos="fade-right"
                className="h-[1px] w-full bg-stone-800"
              />

              <h1
                data-aos="fade-right"
                className="font-medium transition-all duration-300 hover:text-white md:text-2xl xl:text-4xl"
              >
                +62 812 1524 4015
              </h1>
            </div>
          ...
          <div className="border- flex flex-col gap-10 border-gray-600 py-5 text-lg font-medium sm:grid sm:grid-cols-[1fr_2fr] sm:gap-20 sm:py-10 sm:text-xl lg:gap-40">
            <h1
              data-aos="fade-up"
              className="text-4xl font-semibold uppercase sm:order-2 md:text-5xl lg:text-7xl"
            >
              Social Media
            </h1>
      ...
      <section className="flex flex-col gap-10 bg-black px-6 py-20 text-textColor-primary sm:py-40 md:px-10 lg:grid lg:grid-cols-[1fr_2fr] xl:px-20 2xl:px-72">
        ...
        <p
          data-aos="fade-up"
          className="text-[7vw] font-medium leading-tight sm:text-[6vw] md:text-5xl lg:text-6xl"
        >
